...
bool isPointInRegion1(Point3D point,float O2min) {
  ...
  if (point.x >= 0 && point.z >= 0 &&
      point.x * point.x + point.y * point.y + point.z * point.z <  625 &&
      sqrt(point.x * point.x + point.y * point.y + point.z * point.z) > 12) {
...
bool isPointInRegion2(Point3D point,float O2min) {
  ...
  if (point.x >= 0 && point.z >= 0 &&
      point.x * point.x + point.y * point.y + point.z * point.z <  1849 &&
      sqrt(point.x * point.x + point.y * point.y + point.z * point.z) > 12) {
